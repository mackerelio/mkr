...
func TestFormatJoinedAlert(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			&alertSet{
				&mackerel.Alert{ID: "2tZhm", Type: "check", Status: "WARNING", MonitorID: "5rXR3", OpenedAt: 500, Message: "message"},
				nil,
				nil,
				&mackerel.CheckMonitor{ID: "5rXR3", Name: "foo-check-script"},
			},
			"2tZhm 1970-01-01 00:08:20 WARNING foo-check-script message",
		},
	}
