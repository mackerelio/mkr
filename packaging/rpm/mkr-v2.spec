...
- Bump github.com/mackerelio/mackerel-client-go from 0.44.0 to 0.45.0 in the stable-packages group (by dependabot[bot])
- Update supported Linux distributions in README (by mechairoi)
- Bump actions/setup-go from 6.5.0 to 7.0.0 (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.2.1 to 6.2.2 (by dependabot[bot])
- Bump golang.org/x/text from 0.39.0 to 0.40.0 in the stable-packages group (by dependabot[bot])
- Bump docker/login-action from 4.3.0 to 4.4.0 (by dependabot[bot])
- Bump the stable-packages group across 1 directory with 2 updates (by dependabot[bot])
- Bump golang.org/x/crypto from 0.45.0 to 0.52.0 (by dependabot[bot])
- Bump docker/setup-buildx-action from 4.1.0 to 4.2.0 (by dependabot[bot])
- Bump docker/login-action from 4.2.0 to 4.3.0 (by dependabot[bot])
- Bump docker/build-push-action from 7.2.0 to 7.3.0 (by dependabot[bot])
- Bump docker/setup-qemu-action from 4.1.0 to 4.2.0 (by dependabot[bot])
- Bump golang.org/x/text from 0.38.0 to 0.39.0 in the stable-packages group (by dependabot[bot])
- Change Dependabot schedule from daily to weekly (by yseto)
- Bump github.com/urfave/cli/v3 from 3.10.0 to 3.10.1 (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.2.0 to 6.2.1 (by dependabot[bot])
- Bump actions/setup-go from 6.4.0 to 6.5.0 (by dependabot[bot])
- Bump github.com/mackerelio/mackerel-agent from 0.86.3 to 0.87.0 in the stable-packages group (by dependabot[bot])
- Bump actions/checkout from 6.0.3 to 7.0.0 (by dependabot[bot])
- Bump github.com/urfave/cli/v3 from 3.9.1 to 3.10.0 (by dependabot[bot])
- Bump github.com/urfave/cli/v3 from 3.9.0 to 3.9.1 (by dependabot[bot])
- Bump the stable-packages group across 1 directory with 2 updates (by dependabot[bot])
- Bump alpine from 3.23 to 3.24 (by dependabot[bot])
- Bump github.com/mackerelio/mackerel-client-go from 0.42.0 to 0.43.0 in the stable-packages group (by dependabot[bot])
- Bump actions/checkout from 6.0.2 to 6.0.3 (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.1.3 to 6.2.0 (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.1.1 to 6.1.3 (by dependabot[bot])
- Bump docker/setup-qemu-action from 4.0.0 to 4.1.0 (by dependabot[bot])
- Bump docker/login-action from 4.1.0 to 4.2.0 (by dependabot[bot])
- Bump docker/setup-buildx-action from 4.0.0 to 4.1.0 (by dependabot[bot])
- Bump docker/build-push-action from 7.1.0 to 7.2.0 (by dependabot[bot])
- Bump github.com/urfave/cli/v3 from 3.8.0 to 3.9.0 (by dependabot[bot])
- Bump golang.org/x/text from 0.36.0 to 0.37.0 in the stable-packages group (by dependabot[bot])
- Bump github.com/mackerelio/mackerel-client-go from 0.41.0 to 0.42.0 in the stable-packages group (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.1.0 to 6.1.1 (by dependabot[bot])
- Bump github.com/mackerelio/mackerel-agent from 0.86.2 to 0.86.3 in the stable-packages group (by dependabot[bot])
- Bump actions/upload-artifact from 7.0.0 to 7.0.1 (by dependabot[bot])
- Bump docker/build-push-action from 7.0.0 to 7.1.0 (by dependabot[bot])
- Bump the stable-packages group across 1 directory with 2 updates (by dependabot[bot])
- Bump aws-actions/configure-aws-credentials from 6.0.0 to 6.1.0 (by dependabot[bot])
- Bump github.com/mackerelio/mackerel-client-go from 0.40.0 to 0.41.0 in the stable-packages group (by dependabot[bot])
- Bump docker/login-action from 4.0.0 to 4.1.0 (by dependabot[bot])
- Add traces get command for trace retrieval (by kga)
